...
export const defaultLoginThemeConfig: LoginThemeConfig = {
    ...
    showPlaceholder: KC_ENV_DEFAULTS.SHADCN_THEME_SHOW_PLACEHOLDER,
    showRealmName: KC_ENV_DEFAULTS.SHADCN_THEME_SHOW_REALM_NAME,
...
export function themeConfigToProperties(config: LoginThemeConfig): Record<string, string> {
    return {
        ...
        [THEME_PROPERTY_KEYS.showPlaceholder]: serializeKcEnvValue(config.showPlaceholder),
        [THEME_PROPERTY_KEYS.showRealmName]: serializeKcEnvValue(config.showRealmName),
